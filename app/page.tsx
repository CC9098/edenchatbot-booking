...
export default function Home() {
  return (
    <main className="relative min-h-screen bg-gradient-to-br from-emerald-50 via-white to-emerald-100/60 text-slate-800">
      <div className="mx-auto flex max-w-6xl flex-col gap-10 px-6 pb-24 pt-20 sm:px-10 sm:pb-32 sm:pt-28">
        <div className="max-w-3xl space-y-6">
          ...
          <h1 className="text-4xl font-semibold leading-tight text-[#1f3410] sm:text-5xl">
