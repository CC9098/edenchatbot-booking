...
export const CALENDAR_MAPPINGS: CalendarMapping[] = [
  ...
  { 
    ...
    schedule: {
      ...
      6: [{ start: "11:00", end: "14:00" }, { start: "15:30", end: "18:30" }],
    }
  },
  { 
    doctorId: "lee", 
  ...
  { 
    ...
    schedule: {
      0: null,
      1: null,
      2: [{ start: "10:30", end: "14:00" }, { start: "15:30", end: "19:00" }],
      3: null,
      4: null,
      5: [{ start: "10:30", end: "14:00" }, { start: "15:30", end: "19:00" }],
      6: [{ start: "10:30", end: "14:00" }, { start: "15:30", end: "19:00" }],
    }
  },
  { 
    doctorId: "chan", 
  ...
  // ===== Dr. Wong 黃浩哲脊醫 =====
  {
    doctorId: "wong",
    clinicId: "jordan",
    calendarId: "bb9e3b864e99dd1dda3e828e40f2545f245c8e2fd01bd459390c3409e46db4d3@group.calendar.google.com",
    isActive: true,
    effectiveFrom: "2026-05-01",
    schedule: {
      0: null,
